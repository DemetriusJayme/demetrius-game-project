class ParImparGame {
  constructor(player, points) {
    this.player = player;
    this.points = points;
    const carta1 = new deck(1, 1, "./images/mao_um_dedo.png", "um");
    const carta2 = new deck(2, 2, "./images/mao_dois_dedos.png", "dois");
    const carta3 = new deck(3, 3, "./images/mao_tres_dedos.png", "tres");
    const carta4 = new deck(4, 4, "./images/mao_quatro_dedos.png", "quatro");
    const carta5 = new deck(5, 1, "./images/mao_cinco_dedos.png", "cinco");
    this.deck = [carta1, carta2, carta3, carta4, carta5];
